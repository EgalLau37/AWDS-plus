...
Current overview:
	...
	♦Rebalances units to make more units useable
		♪https://docs.google.com/spreadsheets/d/1sKAQt_YcIJz2JVh7RWCgb9Z8nnsRX_tO/edit?usp=sharing&ouid=102492150285942258676&rtpof=true&sd=true
	♦Replaces many vanilla maps with maps designed for competitive PVP
	...
	♦Adds campaign maps from AW2 campaign
		♪Unlocked by completing Hard campaign with an S rank
	♦Adds campaign maps from AW1 campaign
		♪Unlocked by completing Hard campaign with an S rank
	...
	♦Various quality of life changes
		...
		♪Ability to further customize matches using level flags
			☼ability to purchase Oozium, heal from teammate properties, and not refresh units during tag powers
		♪Improved AI determinations for CO powers, CO swap, and unit actions
		...
		♪Scoreboard menu command that displays current score and requirements
